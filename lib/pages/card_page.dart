      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Image.asset("assets/image/basquet.png",
                height: 120,
                width: 120,),
                Expanded(
                  child: Column(
                    children: const [
                      Text("La sensación de un deporte diferente",style: TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontSize: 17.2),),
                      SizedBox(height: 6.0,),                     
            ...
            child: Row(
              children: [
                ...
                ClipRRect(
                  ...
                  child: Image.network(
                    "https://acf.geeknetic.es/imgri/imagenes/auto/21/01/12/wvv-amd-ryzen-5000-porttiles.jpg?f=webp",
                    height: 120.0,
                  ),
                ),
              ],
